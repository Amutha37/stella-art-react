    ...
    <div className='question-container'>
      <div className='whole-list-questions'>
        ...
        <div className='question-answer'>
          ...
          <p className='each-answer'>
            A2. Yes, I do sell original artworks which is all painted by myself.
            A signed Certificate of Authenticity is given with each artwork.
          </p>
        </div>
        ...
        <div className='question-answer'>
          ...
          <p className='each-answer'>
            A7. Through the Post Office firmly secured, or depending on location
            I may be able to deliver it to your door.
          </p>
        </div>
      </div>
    </div>
